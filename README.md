...
```
JATSdecoder: A Metadata and Text Extraction and Manipulation Tool Set. Ingmar Böschen (2022). R package version 1.1.
```
### Resources
**Articles:**
...
The [PubMed Central](https://www.ncbi.nlm.nih.gov/pmc/) database offers more than 3.8 million documents related to the biology and health sciences. The full repository is bulk downloadable as NISO-JATS coded NXML documents here: [PMC bulk download](https://ftp.ncbi.nlm.nih.gov/pub/pmc/oa_bulk/). 
...
- Böschen, I. (2022). Evaluation of the extraction of methodological study characteristics with JATSdecoder. Scientific Reports **13**, 193. https://doi.org/10.1038/s41598-022-27085-y
</div>
